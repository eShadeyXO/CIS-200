...
namespace Prog0
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Package p1 = new NextDayAirPackage(a3, a4, 5, 5, 5, 5, 10);
            Package p2 = new TwoDayAirPackage(a1, a2, 50, 20, 50, 100, TwoDayAirPackage.Delivery.Saver);
            Package p3 = new TwoDayAirPackage(a2, a3, 10, 10, 10, 75, TwoDayAirPackage.Delivery.Early);
